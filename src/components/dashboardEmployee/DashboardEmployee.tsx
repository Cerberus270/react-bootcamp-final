import { Avatar, AvatarBadge, Box, Container, Divider, FormControl, Input, FormErrorMessage, FormLabel, SimpleGrid, Textarea, useDisclosure, useToast, VStack, HStack, Center } from '@chakra-ui/react';
...
import { addNewSick, getSickByEmployee, IApplicationData, IApplicationForm } from '../../utils/sdk';
...
const DashboardEmployee = () => {
    ...
    const getData = async () => {
        setLoading(true);
        //await getSickByEmployee(store.user.id);
        let sickAplicationsT: any[] = await getSickByEmployee(store.user.id);;
            ...
            <Container maxW='container.full'>
                ...
                {/*We pass the sickApplications to the TableHr*/}
                {
                    loading ? (
                        ...
                        <>
                            <TableEmployee data={sickApplications} />
                        </>
                    )
                }
